...
public:
    ...
    double learning_rate_factor = 250;
    double decrease_speed = 0.001;
...
//        learning_rate_factor += 0.001;
    ...
    DynamicElementWiseSegment(double init_learning_rate_factory = 250,double init_decrease_speed = 1e-5) :
    learning_rate_factor(init_learning_rate_factory),decrease_speed(init_decrease_speed),
