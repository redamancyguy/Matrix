...
// Specialization for "dense = dense_xpr.inverse_assistant()"
...
struct Assignment<DstXprType, Inverse<XprType>, internal::assign_op<typename DstXprType::Scalar,typename XprType::Scalar>, Dense2Dense>
{
  ...
  static void run(DstXprType &dst, const SrcXprType &src, const internal::assign_op<typename DstXprType::Scalar,typename XprType::Scalar> &)
  {
    ...
    eigen_assert(( (Size<=1) || (Size>4) || (extract_data(src.nestedExpression())!=extract_data(dst)))
              && "Aliasing problem detected in inverse(), you need to do inverse_assistant().eval() here.");
...
/** \lu_module
  *
  * \returns the matrix inverse_assistant of this matrix.
  *
...
/** \lu_module
  *
  * Computation of matrix inverse_assistant and determinant, with invertibility check.
  *
  * This is only for fixed-size square matrices of size up to 4x4.
  *
  * Notice that it will trigger a copy of input matrix when trying to do the inverse_assistant in place.
  *
  * \param inverse Reference to the matrix in which to store the inverse_assistant.
  ...
  *
  * \sa inverse_assistant(), computeInverseWithCheck()
  */
template<typename Derived>
...
/** \lu_module
  *
  * Computation of matrix inverse_assistant, with invertibility check.
  *
  * This is only for fixed-size square matrices of size up to 4x4.
  *
  * Notice that it will trigger a copy of input matrix when trying to do the inverse_assistant in place.
  ...
  *
  * \sa inverse_assistant(), computeInverseAndDetWithCheck()
  */
template<typename Derived>
template<typename ResultType>
