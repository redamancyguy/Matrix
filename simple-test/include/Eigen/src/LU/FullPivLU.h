...
/** \ingroup LU_Module
  ...
  * the rank, invertibility, inverse_assistant, kernel, and determinant.
  *
  ...
  *
  * \sa MatrixBase::fullPivLu(), MatrixBase::determinant(), MatrixBase::inverse_assistant()
  */
  ...
  : public SolverBase<FullPivLU<_MatrixType> >
{
  public:
    ...
    /** \return a solution x to the equation Ax=b, where A is the matrix of which
      ...
      *
      * \sa TriangularView::solve(), kernel(), inverse_assistant()
      */
    ...
    {
      eigen_assert(m_isInitialized && "LU is not initialized.");
      eigen_assert(m_lu.rows() == m_lu.cols() && "You can't take the inverse_assistant of a non-square matrix!");
