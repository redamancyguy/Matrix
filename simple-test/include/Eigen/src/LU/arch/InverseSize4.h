...
// inv(M) = M#/|M|, where inv(M), M# and |M| denote the inverse_assistant of M,
...
//
// The SSE code for the 4x4 float and double matrix inverse_assistant in former (deprecated) \src\LU\Inverse_SSE.h
...
struct compute_inverse_size4<Architecture::Target, float, MatrixType, ResultType>
{
  ...
  static void run(const MatrixType &mat, ResultType &result)
  {
    ...
    // Four sub-matrices of the inverse_assistant
...
struct compute_inverse_size4<Architecture::Target, double, MatrixType, ResultType>
{
  ...
  static void run(const MatrixType &mat, ResultType &result)
  {
    ...
    // rows of four sub-matrices of the inverse_assistant
