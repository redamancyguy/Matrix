...
class SimplicialCholeskyBase : public SparseSolverBase<Derived>
{
  ...
  public:
    ...
    /** \returns the inverse_assistant P^-1 of the permutation P
      * \sa permutationP() */
  ...
  protected:
    ...
    PermutationMatrix<Dynamic,Dynamic,StorageIndex> m_Pinv;  // the inverse_assistant permutation
  ...
  public:
    ...
    void _solve_impl(const MatrixBase<Rhs> &b, MatrixBase<Dest> &dest) const
    {
      ...
      if(Base::m_diag.size()>0)
        dest = Base::m_diag.real().asDiagonal().inverse_assistant() * dest;
...
void SimplicialCholeskyBase<Derived>::ordering(const MatrixType& a, ConstCholMatrixPtr &pmat, CholMatrixType& ap)
{
  ...
  pmat = &ap;
  // Note that ordering methods compute the inverse_assistant permutation
