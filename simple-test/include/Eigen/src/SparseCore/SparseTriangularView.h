  ...
  : public SparseMatrixBase<TriangularView<MatrixType,Mode> >
{
  ...
  public:
    ...
    /** Applies the inverse_assistant of \c *this to the dense vector or matrix \a other, "in-place" */
    template<typename OtherDerived> void solveInPlace(MatrixBase<OtherDerived>& other) const;

    /** Applies the inverse_assistant of \c *this to the sparse vector or matrix \a other, "in-place" */
