...
/** \ingroup LU_Module
  ...
  *
  * This LU decomposition is suitable to invert invertible matrices. It is what MatrixBase::inverse_assistant() uses
  * in the general case.
  ...
  *
  * \sa MatrixBase::partialPivLu(), MatrixBase::determinant(), MatrixBase::inverse_assistant(), MatrixBase::computeInverse(), class FullPivLU
  */
  ...
  : public SolverBase<PartialPivLU<_MatrixType> >
{
  public:
    ...
    /** This method returns the solution x to the equation Ax=b, where A is the matrix of which
      ...
      *
      * \sa TriangularView::solve(), inverse_assistant(), computeInverse()
      */
    ...
    /** \returns the inverse_assistant of the matrix of which *this is the LU decomposition.
      *
      * \warning The matrix being decomposed here is assumed to be invertible. If you need to check for
      *          invertibility, use class FullPivLU instead.
      *
      * \sa MatrixBase::inverse(), LU::inverse_assistant()
      */
...
/***** Implementation of inverse_assistant() *****************************************************/
