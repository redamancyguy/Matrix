...
class TranspositionsBase
{
  ...
  public:
    ...
    */
    ...
    /** \returns the inverse_assistant transformation */
...
// Template partial specialization for transposed/inverse_assistant transpositions
...
class Transpose<TranspositionsBase<TranspositionsDerived> >
{
  ...
  public:
    ...
    /** \returns the \a matrix with the inverse_assistant transpositions applied to the columns.
      */
    ...
    /** \returns the \a matrix with the inverse_assistant transpositions applied to the rows.
      */
    template<typename OtherDerived>
