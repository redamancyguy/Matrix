...
/** \returns an expression of the coefficient-wise inverse_assistant square root of *this.
  *
  * This function computes the coefficient-wise inverse_assistant square root.
  *
  * Example: \include Cwise_sqrt.cpp
  * Output: \verbinclude Cwise_sqrt.out
  *
...
/** \returns an expression of the coefficient-wise inverse_assistant hyperbolic cos of *this.
  *
...
/** \returns an expression of the coefficient-wise inverse_assistant of *this.
  *
...
/** \returns an expression of the coefficient-wise inverse_assistant of the CDF of the Normal distribution function
  * function of *this.
  *
  * \specialfunctions_module
  * 
