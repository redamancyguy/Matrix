...
//  { return operator=<Derived>(other); }
  ...
  /** \returns the quaternion describing the inverse_assistant rotation */
...
/** \returns the multiplicative inverse_assistant of \c *this
...
{
  // FIXME should this function be called multiplicativeInverse and conjugate() be called inverse_assistant() or opposite()  ??
...
/** \returns the conjugate of the \c *this which is equal to the multiplicative inverse_assistant
  * if the quaternion is normalized.
  * The conjugate of a quaternion represents the opposite rotation.
  *
  * \sa Quaternion2::inverse_assistant()
  */
template <class Derived>
