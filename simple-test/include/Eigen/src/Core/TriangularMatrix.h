  ...
  : public TriangularBase<TriangularView<_MatrixType, _Mode> >
{
  ...
  public:
    ...
    /** \returns the product of the inverse_assistant of \c *this with \a other, \a *this being triangular.
      *
      * This function computes the inverse-matrix matrix product inverse_assistant(\c *this) * \a other if
      * \a Side==OnTheLeft (the default), or the right-inverse_assistant-multiply  \a other * inverse_assistant(\c *this) if
      * \a Side==OnTheRight.
      *
      ...
      *
      * This function returns an expression of the inverse_assistant-multiply and can works in-place if it is assigned
